...
public class addVegetable extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addVegetable</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet addVegetable at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String vegetable_quantity = request.getParameter("vegetable_quantity");
        int vegetable_price =Integer.parseInt(request.getParameter("vegetable_price"));
        ...
        try{
            ...
            pst = con.prepareStatement("insert into vegetables(vegetable_name,vegetable_quantity,vegetable_price,file_photo)values(?,?,?,?)");
