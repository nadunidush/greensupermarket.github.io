...
public class feedback extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String user_message = request.getParameter("usermessage");
        ...
        try{
            ...
            pst = con.prepareStatement("insert into feedbacks(username,useremail,usermessage)values(?,?,?)");
            pst.setString(1,user_name);
            pst.setString(2,user_email);
            pst.setString(3,user_message);
            pst.executeUpdate();
