...
public class addFish extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addFish</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet addFish at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String fish_quantity = request.getParameter("fish_quantity");
        int fish_price =Integer.parseInt(request.getParameter("fish_price"));
        ...
        try{
            ...
            pst = con.prepareStatement("insert into fish(fish_name,fish_quantity,fish_price,file_photo)values(?,?,?,?)");
            pst.setString(1,fish_name);
            pst.setString(2,fish_quantity);
            pst.setInt(3,fish_price);
